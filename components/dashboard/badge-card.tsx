        ...
        {badges.map((badge) => {
          ...
          return (
             <div key={badge.title} className="flex flex-col items-center text-center">
                ...
                <h4 className="text-[11px] font-bold text-slate-900 dark:text-white leading-tight mb-1 max-w-[60px]">{badge.title}</h4>
                <p className="text-[9px] font-medium text-slate-400 dark:text-slate-500 leading-tight">{badge.description}</p>
             </div>
          )
        })}
      </div>
